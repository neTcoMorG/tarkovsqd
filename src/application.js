...
if (MODE === 'dev') {
	...
	DISCORD_LOGIN_URL = 'https://discord.com/api/oauth2/authorize?client_id=1159029609552171049&redirect_uri=http://localhost:3000/discord&response_type=code&scope=identify';
}
